...
# 📖 Patient Record <a name="about-project"></a>

**Patient Record** is an SQL database created by postgresql. In the database, there are multiple tables linked together to carry out the details of patient history, their treatment history and invoices. The database is created from a schema diagram.
...
https://github.com/AliRezaBmeDu/patient-record.git
...
Feel free to check the [issues page](https://github.com/AliRezaBmeDu/patient-record/issues).
